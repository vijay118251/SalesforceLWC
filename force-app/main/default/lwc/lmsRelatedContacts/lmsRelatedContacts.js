...
import getRelatedContactsByFilter from '@salesforce/apex/ContactControllerCall.getRelatedContactsByFilter';
...
export default class LmsRelatedContacts extends LightningElement {
    ...
    connectedCallback(){
        ...
        console.log('Subscriber Component');
    ...
    loadRelatedContacts(filterKey){
        ...
        .then(results=>{
            this.data=results;
            console.log('Callout::',JSON.stringify(this.data));
        })
        .catch(error=>{
            this.dispatchEvent(
                new ShowToastEvent({
    ...
    handleFilterKeySubmit(message){
        ...
        console.log('loadRelatedContacts Method call');
